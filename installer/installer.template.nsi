...
OutFile "..\dist\v__VERSION__\AppMonitor_Setup_${PRODUCT_VERSION}.exe"
...
Section "!Основные файлы" SecCore
    SectionIn RO
    SetOutPath "$INSTDIR"
    File "..\dist\v__VERSION__\AppMonitor.exe"
    File "..\version.txt"
...
Section -PostInstall
    ${If} $AUTORUN_FLAG == "1"
        Sleep 2000
        nsExec::ExecToStack 'taskkill /f /im AppMonitor.exe 2>nul'
        Sleep 500
    ${EndIf}
